...
const team = [
  ...
  {
    name: "Sofia Greenberg",
    desc: "Sofia Greenberg has been part of the World Health Access Team (WHAT) since 2019 and has participated in multiple venous ulcer programs alongside the Hacket Hemwall Patterson Foundation. Her efforts have been featured in multiple news outlets, including the LA Times and the Univision morning show. She spearheaded the “Let’s Dress Honuras Campaign,” which raised over 4,000 pounds of clothing, shoes, toys, and school supplies. These donations were distributed to multiple schools and underserved communities in Honduras. In 2024, she was the primary interpreter for the inaugural dialysis access fistula program. She is currently studying chemistry at UCLA and looks forward to attending medical school. She hopes to continue her work in helping the underserved. ",
    image1: require("../imgs/team/sofia.jpg"),
    images: [require("../imgs/team/sofia_news.jpg")],
  },
];
