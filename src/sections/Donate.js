...
const Donate = () => {
  return (
    <div id="contribute" className=" my-16">
      <div className="md:mx-[10%] ">
        <h1 className=" text-7xl text-orange-500">Give a Helping Hand</h1>
        <div className="mx-8 md:mx-16">
          ...
          <span className=" text-blue-500 font-extrabold">donations</span>, you
        ...
        <div className=" border-2 border-slate-500 mx-4">
          <h1 className=" text-3xl">Donate</h1>
          <div className=" border-2 border-slate-400 rounded-xl p-4 m-4 text-slate-600 border-l-0 border-r-0">
        ...
        <div className=" border-2 border-slate-500 mx-4 mt-16">
