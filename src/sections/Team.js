  ...
  return (
    <div className=" py-16">
      ...
      <p className="text-lg pb-14 px-[min(5vw)] text-left">
        ...
        Dr. Bui and A. Greenberg were already championing advanced vascular care
        in Vietnam, while Dr. McHutchison and T. Zimmerman were actively
        ...
        these nations. It is this collective dedication and vision that brought
        WHAT into existence, as a unique force poised to make a transformative
